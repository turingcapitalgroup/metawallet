...
/// @title IERC7540
/// @notice Interface for Asynchronous Tokenized Vaults, extending ERC-4626
interface IERC7540 is IERC4626 {
    ...
    /// @notice Emitted when a redemption request is made
    /// @param controller The address that controls the request
    ...
    /// @notice Request a deposit of assets into the vault
    ...
    /// @notice Request a redemption of shares from the vault
    ...
    /// @notice Returns the amount of requested assets pending for a controller
    ...
    /// @notice Returns the amount of requested assets claimable for a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of requested shares pending for a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of requested shares claimable for a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of assets that can be deposited by a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of shares that can be minted by a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of shares that can be redeemed by a controller
    /// @param controller The address to check
    ...
    /// @notice Returns the amount of assets that can be withdrawn by a controller
    /// @param controller The address to check
